...
|------:|-----------------:|----------:|--------------:|
| 1 | ~165 tiles | ~400 small chambers | 10% |
| 5 | ~221 tiles | ~+5%/level target (denser in practice) | 18% |
| 10 | ~290 tiles | ~1200+ small chambers | 28% |

Rules:

- **Square** maps; rooms clustered in the playable middle with solid-rock padding
- **Small cozy chambers** (~**5–9 tiles** on a side, square or slightly rectangular) — **no hallways**, **no shut doors**
- Rooms connect **only** by open doorways cut in **shared walls**
- Dense pack of many rooms; most have 2+ doorways; ~10% dead-ends on L1, **+2% per level**, **+5% more rooms** per level
