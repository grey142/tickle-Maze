...
- **Camera:** Close-up **room-locked** **straight overhead (top-down)** view. **Fits/centers the whole room** when it fits the viewport; otherwise **follow-camera** with mid-wall clamp (neighboring rooms stay off-screen)
...
- `js/game.js` — gameplay, room-locked top-down camera, sprint, keys/gate, enemies, QTE, HUD, overhead render
